...
WindowsFeatureBlock "Virtual Machine Platform" VirtualMachinePlatform
...
Block "Update to WSL 2" {
    ...
    iwr https://wslstorestorage.blob.core.windows.net/wslblob/wsl_update_x64.msi -OutFile $env:tmp\wsl_update_x64.msi
