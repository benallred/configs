...
StopOnError 1 {
    ...
    dotnet run --project $git\YouTubeToPlex\YouTubeToPlex\ -- --playlist-id PLGVpxD1HlmJ8GxbiW7jdGzPlKJeO5sz3B --download-folder "E:\Media\Ben\TV\Family TV\Studio C" --season 11
}
