...
if (!((Test-ProgramInstalled "Microsoft Office Professional Plus 2019") -or (Test-ProgramInstalled "Microsoft Office 365"))) {
    InstallFromWingetBlock Microsoft.Office "/configure $PSScriptRoot\OfficeConfiguration.xml" {
        ...
        #               LICENSE STATUS:  ---LICENSED---
        #               Last 5 characters of installed product key: <correct>
        #       Automated install (product id = ProPlus2019Volume), activate from command line
        ...
        #           Turns out the key doesn't match the installed SKU/product id
        #       Automated install (product id = ProPlus2019Retail), activate from command line
        #           WORKED
